...
class ShopController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('shop', compact('products', 'page', 'size', 'order', 'brands', 'q_brands', 'categories', 'q_categories', 'from', 'to', 'prange'));
    }
