    ...
    <div class="container">
        <div class="row">
                                    ...
                                    <ul class="category-list">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="br{{ $brand->id }}" name="brands" @if (in_array($brand->id, explode(',', $q_brands))) checked="checked" @endif value="{{ $brand->id }}" type="checkbox" onchange="filterProduct()">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                                <div class="accordion-body category-scroll">
                                    <ul class="category-list">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="ct{{ $category->id }}" name="categories" type="checkbox" onchange="filterProductByCategory(this)" @if (in_array($category->id, explode(',', $q_categories))) checked="checked" @endif value="{{ $category->id }}">
            ...
            <div class="category-product col-lg-9 col-12 ratio_30">
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        @if ($product->category)
                                        <span class="font-light grid-content">{{ $product->category->name }}</span>
                                        @endif                                        <p class="font-light">{{ $product->short_description }}.</p>
                                    </div>
                ...
                <!-- Pagination section -->
                {{ $products->appends(['size' => $size, 'order' => $order, 'brands' => $q_brands, 'categories' => $q_categories, 'prange' => $prange])->links('pagination.default') }}
            </div>
        </div>
    </div>
</section>
